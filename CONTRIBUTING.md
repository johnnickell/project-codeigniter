...
Read `AGENTS.md`, `ARCHITECTURE.md`, `planning/README.md`, and the focused local planning rules before proposing a change. Create or update one repository-local ticket, keep work to a vertical slice, update behavior documentation, and run `./bin/build` before requesting review.
